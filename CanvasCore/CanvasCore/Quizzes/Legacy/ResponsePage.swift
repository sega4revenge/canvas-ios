...
struct ResponsePage<T> {
    ...
    func getNextPage(_ response: @escaping (PaginatedResult)->()) -> URLSessionTask? {
        if let nextPage = nextPage {
            ...
            let error = NSError(domain: "vn.flexidata.lms.authentication", code: 0, userInfo: [NSLocalizedDescriptionKey: NSLocalizedString("The Pages are gone!? Why are the pages always gone?", tableName: "Localizable", bundle: .core, value: "", comment: "This shouldn't ever happen.")])
