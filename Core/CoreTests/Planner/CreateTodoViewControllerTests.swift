...
class CreateTodoViewControllerTests: CoreTestCase {
    ...
    func testLayout() {
        ...
        api.mock(createNoteRequest, data: nil, response: nil, error: nil, baseURL: URL(string: "https://lms.flexidata.vn")!, accessToken: nil, dataHandler: {
            createExpectation.fulfill()
            return (nil, nil, nil)
        }, taskID: 1)

        api.mock(refreshPlannablesRequest, data: nil, response: nil, error: nil, baseURL: URL(string: "https://lms.flexidata.vn")!, accessToken: nil, dataHandler: {
