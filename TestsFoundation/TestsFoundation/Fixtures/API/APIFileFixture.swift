...
extension APIFile {
    public static func make(
        ...
        url: URL = URL(string: "https://lms.flexidata.vn/files/1/download")!,
        size: Int = 1024,
...
extension APIFileFolder {
    public static func make(
        ...
        position: Int? = nil,
        updated_at: Date = Date(),
        folders_url: URL = URL(string: "https://lms.flexidata.vn/api/v1/folders/1/folders")!,
        files_url: URL = URL(string: "https://lms.flexidata.vn/api/v1/folders/1/files")!,
